...
import { Smartphone, Zap, Shield, Clock, CheckCircle2 } from "lucide-react";
import { Link } from "react-router-dom";

export function DataService() {
  const features = [
    { title: "Instant Delivery", desc: "Data is delivered to your phone immediately after payment confirmation.", icon: Zap },
    { title: "All Networks", desc: "We support MTN, Airtel, Glo, and 9mobile data plans.", icon: Smartphone },
    { title: "Secure Payment", desc: "Your transactions are protected with industry-standard encryption.", icon: Shield },
    { title: "24/7 Availability", desc: "Buy data anytime, anywhere, even in the middle of the night.", icon: Clock },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-black text-[#0B1C3D] mb-8 leading-tight">
              Cheap & Fast <span className="text-[#0076FF]">Data Plans</span> for All Networks
            </h1>
            <p className="text-slate-600 text-lg mb-10 leading-relaxed">
              Stay connected with our affordable data bundles. Whether you need SME data, Gifting, or Corporate Gifting, we have the best rates in Nigeria. Our system is fully automated, ensuring you get your data instantly.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/pricing" className="bg-white text-[#0B1C3D] border border-slate-200 px-8 py-4 rounded-2xl font-bold hover:bg-slate-50 transition-all">View Data Prices</Link>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100">
              ...
              <p className="text-3xl font-black text-blue-600">₦250/GB</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="bg-[#0B1C3D] rounded-[3rem] p-12 lg:p-20 text-white">
          <div className="max-w-3xl">
            <h2 className="text-3xl lg:text-5xl font-black mb-8">How to Buy Data</h2>
            <div className="space-y-8">
              {[
                "Create a free account on SwiftRecharge.",
                "Fund your wallet using any of our secure payment methods.",
                "Select 'Buy Data' from your dashboard.",
                "Choose your network, plan, and enter the phone number.",
                "Confirm and receive your data instantly!"
              ].map((step, i) => (
