...
import { Smartphone, Zap, Shield, Clock, PhoneCall } from "lucide-react";
import { Link } from "react-router-dom";

export function AirtimeService() {
  const features = [
    { title: "Instant Top-up", desc: "Airtime is delivered to your phone immediately after payment confirmation.", icon: Zap },
    { title: "All Networks", desc: "We support MTN, Airtel, Glo, and 9mobile airtime VTU.", icon: Smartphone },
    { title: "Secure Payment", desc: "Your transactions are protected with industry-standard encryption.", icon: Shield },
    { title: "24/7 Availability", desc: "Buy airtime anytime, anywhere, even in the middle of the night.", icon: Clock },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-blue-600 font-bold text-sm mb-6">
              ...
              Airtime VTU Services
            </div>
            <h1 className="text-4xl lg:text-6xl font-black text-[#0B1C3D] mb-8 leading-tight">
              Instant <span className="text-[#0076FF]">Airtime</span> Recharge with Discounts
            </h1>
            <p className="text-slate-600 text-lg mb-10 leading-relaxed">
              Never run out of airtime again! SwiftRecharge provides instant airtime VTU for all Nigerian networks. Enjoy up to 3% discount on every recharge you make through our platform.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/pricing" className="bg-white text-[#0B1C3D] border border-slate-200 px-8 py-4 rounded-2xl font-bold hover:bg-slate-50 transition-all">View Discounts</Link>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-slate-100">
              <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-1">Cashback up to</p>
              <p className="text-3xl font-black text-blue-600">3% OFF</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="bg-[#0B1C3D] rounded-[3rem] p-12 lg:p-20 text-white">
          <div className="max-w-3xl">
            <h2 className="text-3xl lg:text-5xl font-black mb-8">How to Buy Airtime</h2>
            <div className="space-y-8">
              {[
                "Create a free account on SwiftRecharge.",
                "Fund your wallet using any of our secure payment methods.",
                "Select 'Buy Airtime' from your dashboard.",
                "Choose your network and enter the phone number.",
                "Confirm and receive your airtime instantly!"
              ].map((step, i) => (
